    ...
    public function __invoke(Request $request): JsonResponse
    {
        ...
        $announcements = DB::table('announcements')
            ...
            ->select([
                ...
                'announcements.published_on as published_on',
                'announcements.effective_from',
                'announcements.effective_to',
            ...
            ->map(function ($announcement) use ($announcementRecipientMap, $announcementVoteOptionsMap, $announcementVoteCountsMap, $currentUserVotes) {
                ...
                return [
                    ...
                    'date' => $announcement->effective_from ?: $announcement->date,
                    'publishedOn' => $announcement->published_on,
                    'effectiveFrom' => $announcement->effective_from,
                    'effectiveTo' => $announcement->effective_to,
