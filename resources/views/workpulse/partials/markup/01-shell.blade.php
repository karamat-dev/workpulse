    ...
    <div class="login-panel">
      ...
      <div class="login-form-card">
        <div class="lf-group">
          ...
          <input type="email" class="lf-input" id="l-email" placeholder="Enter your email" autocomplete="off" readonly onfocus="this.removeAttribute('readonly')">
        </div>
        <div class="lf-group">
          <label class="lf-label">Password <span class="req-star">*</span></label>
          <div class="password-input-wrap">
            <input type="password" class="lf-input" id="l-pass" placeholder="Enter password" autocomplete="new-password" readonly onfocus="this.removeAttribute('readonly')">
