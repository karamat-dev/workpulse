...
window.openEditLeaveRequest = openEditLeaveRequest;
...
window.toggleEmployeeDirectorySelection = toggleEmployeeDirectorySelection;
window.updateEmployeeBulkSelection = updateEmployeeBulkSelection;
window.bulkRemoveSelectedEmployees = bulkRemoveSelectedEmployees;
window.scrollEmployeeDirectory = scrollEmployeeDirectory;
...
window.uploadEmployeeDocuments = uploadEmployeeDocuments;
