...
<body style="font-family:Arial,sans-serif;color:#1D2438;line-height:1.5;">
  <h2 style="margin:0 0 12px;">muSharp deletion alert</h2>
  <p>An admin deleted or removed data in muSharp.</p>
  ...
  <p>Open muSharp as Super-Admin and go to Backups & Restore to recover it if needed.</p>
</body>
</html>
